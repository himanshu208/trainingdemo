...
<html>
<head>
<title>Corporate Training Provider, Certification &amp; Courses</title>
<meta charset="utf-8">
<meta name="description" content="JanBask Training, Leading online Corporate certification providers, offers online Corporate IT training courses to help professionals get certified.">
					...
					<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border:solid 1px #CFCFD3; border-radius:4px; background:#fff;">
						...
						<div>  
							...
							<div style="margin-bottom:20px;" class="">
								<div class="row"><div  class="col-lg-3 col-md-3 hidden-sm hidden-xs"></div>
									<div  class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
										<div class="inner underline no-margin">
											<h1 class="inside-banner" style="color:#666;">Looking for Corporate Training?</h1>
											<p style=" line-height:20px;">Make Your Team Professional with Janbask Training</p>
											<span id="success_message"></span>
											<?php	echo form_open_multipart("Home/submit_corporate_enquiry",array("id"=>"corporate_enquiry_form"));	?>
												<div class="content">
...
<div class="form-group">
													...
													<div class="form-group">
														<?php	echo form_input(array("type"=>"text","class"=>"form-control","placeholder"=>"ENTER YOUR COMPANY NAME","id"=>"corp_enq_company","name"=>"corp_enq_company","required"=>"required"));	?>
													</div>
													<div class="form-group">
									...
									<div  class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										<img src="<?php	echo site_url('assets/img/corporate-train.jpg');	?>" >
									</div>
		...
		<script>
		$("#corporate_enquiry_form").on("submit",function(evt)
		{
			...
			var company=$("#corp_enq_company").val();
			...
			var post_data={"name":name,"email":email,'country_code':country_code,"mobile":mobile,"company":company,"course":course,"country":country,"state":state,"pincode":pincode,"message":message};
			$.ajax({
				url:"<?php echo site_url("submit_corporate_enquiry");?>",
				data:post_data,
				type:"POST",
