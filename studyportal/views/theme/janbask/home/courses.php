        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 wow fadeInLeft" align="left" style="margin-top:20px;">
         <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("online-java-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
               <a href="<?php	echo site_url("online-java-training");	?>"class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("courses/salesforce");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("courses/salesforce");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("business-analyst-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("courses/ba");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("online-qa-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
               <a href="<?php	echo site_url("online-qa-training");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("pmp-course");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("pmp-course");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("hadoop-big-data-analytics");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
               <a href="<?php	echo site_url("hadoop-big-data-analytics");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
        </div>
        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 wow fadeInLeft" align="left" style="margin-top:20px;">
         <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("iphone-application-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
               <a href="<?php	echo site_url("iphone-application-training");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("courses/android");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("courses/android");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("dotnet-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("dotnet-training");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("courses/vmware");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("courses/vmware");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("oracle-dba-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("oracle-dba-training");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
          <div class="col-md-2 col-sm-12 col-lg-2 col-xs-12 wow fadeInLeft" align="left">
            ...
            <div class="" style="background-color:#f1f1f1;"><a href="<?php	echo site_url("online-sql-server-training");	?>">
              ...
              <div class="enrolltd" align="center"><span class="input-group-btn">
                <a href="<?php	echo site_url("online-sql-server-training");	?>" class="btn btn-store1 btn-store" type="submit" name="submit">View Details</a>
                </span></div></div>
            </div>
          </div>
        </div>
