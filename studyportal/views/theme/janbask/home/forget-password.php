								...
								<div class="row">
									...
									<div style="padding:30px 20px 30px 20px;" class="col-lg-6 col-sm-6 col-xs-12">
										<div class="inner underline no-margin">
											<h1  class="inside-banner" class="inside-banner" style="color:#666;">Forgot Password?</h1>
											<span style=" line-height:25px;">To reset your password, enter your registered email address here.</span>
											<?php	echo form_open_multipart("",array("id"=>"forget_pass_form"));	?>
												<div class="content">
													<div class="form-group">
														<!--<label class="control-label">E-Mail Address:</label>-->
														<?php	echo form_input(array("type"=>"text","class"=>"form-control","placeholder"=>"Enter Registered Email Here","id"=>"forget_pass_email","name"=>"forget_pass_email"));	?>
														<div class="validation-error" id="forget_email_error"></div>
													</div>
													<div class="form-group">
													...
													<div class="form-group" align="center">
														<div class="enrolltd" align="center">
															...
															<span class="input-group-btn">
																<!--<button class="btn btn-store" type="submit" name="submit">Send Email</button>-->
																<?php	echo form_submit(array("class"=>"btn btn-store","value"=>"Send Email"));	?>
															</span>
														</div>
													</div>
												</div>
