		...
		<div style="margin-bottom:20px;" class="login-content wrapper">
            ...
            <div style="padding:30px 20px 30px 20px;" align="center" class="col-lg-12 col-sm-12 col-xs-12">
					...
					<div class="inner underline no-margin">
						<h1  class="inside-banner" class="inside-banner" style="color:#666;">Thank you for registering with JanBask Training!<br>
						</h1>
						<p style="color:#666;">You will receive a verification link on your Email ID, verify it and you’re all ready to go.</p>
