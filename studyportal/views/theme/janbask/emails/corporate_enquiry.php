...
<div class="container" style="border:1px solid #f1f1f1;">
  <div class="header" style="padding:10px; background:#F1F1F1;  " align="center"><a href="#" style="cursor:default;" ><img src="http://janbaskdemo.com/jbworkdesign/img/jbt-logo-color.png" alt="JanBask Training" name="Janbask Training"  id="Janbask Training" style="" /></a> 
    <!-- end .header --></div>
 
  <div class="content" align="center" style=" margin-bottom:10px; ">
 
  <h2 style="margin:5px 0px;">Enquiry from Corporate Training Page</h2>
  ...
  <tr align="center" class="tablecontent">
    <td align="left" style="">Country Code</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $country_code; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Email</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $email; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Mobile</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $mobile; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Company</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $company; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Course</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $course; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Country</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $country; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">State</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $state; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Pincode</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $pin_code; ?></td>    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style="">Message</td>
	<td align="left" style="">:</td>
    <td align="left" style=""><?php echo $message; ?></td>    
  </tr>
  ...
  <div align="left"><img src="<?php	echo site_url('assets/email_images/unnamed.jpg');	?>" style="width:100%;"></div>
...
<p align="center" style="font-size:25px; color:#fff;">Explore Our Course Library <br><br>
    ...
    <a href="<?php	echo site_url();	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff; text-decoration:none; font-size:20px;">Start Exploring</a>
    </p>
