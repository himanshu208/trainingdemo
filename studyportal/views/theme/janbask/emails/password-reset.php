...
<div class="container" style="border:1px solid #f1f1f1;">
  <div class="header" style="padding:10px; background:#F1F1F1;  " align="center"><a href="#" style="cursor:default;"><img src="http://janbaskdemo.com/jbworkdesign/img/jbt-logo-color.png" alt="" name="Janbask Training"  id="Janbask Training" style="" /></a> 
    <!-- end .header --></div>
 
  <div class="content" align="center" style=" margin-bottom:10px; ">
  <h1 style="font-size:18px;">Lost Your Possword?</h1>
  <p align="center">You can reset your password by clicking on the link below.
 <br><br>

    <a href="<?php	echo $url;	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff; text-decoration:none;">Reset Password</a><br><br>
    </p>
  <div align="left"><img src="<?php	echo site_url('assets/email_images/1442878814251.png');	?>" style="width:100%;"></div>
