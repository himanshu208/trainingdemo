...
<div class="container" style="border:1px solid #f1f1f1;">
  ...
  <p align="justify" style="padding:0 20px;">Following is the class data; Please check the details and download the study Material. <br>
...
<?php	echo date("d M Y",strtotime($class_details[0]->class_date));	?></td>
    <td align="right" style=""><?php	echo $class_details[0]->trainer_name;	?></td>
    
  </tr>
  <tr align="center" class="tablecontent" >
    <td style=" padding:10px;" colspan="2" >Class Data Download Link </td><td style=" padding:10px;"  > <a href="<?php	echo $class_details[0]->download_file_url;	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff !important; text-decoration:none;">Download PDF/PPT</a></td>
    <td style=" padding:10px;"  ><a href="<?php	echo $class_details[0]->download_video_url;	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff !important; text-decoration:none;">Download Video</a></td>
 ...
 <p>   <strong>Instructions To Play The Class Recording:</strong><br>
Download & Install the WebEx Player to play the class recordings.<br>

<strong>WebEx Player Download Link :</strong><br>

<strong>For Windows: </strong> <a href="">Click Here</a><br>

<strong>For MacBook:</strong> <a href="">Click Here</a><br>

After installing WebEx, you may download & play the Class Recording Video.

<p align="center">In case of any issue regarding downloading the data<br>
