...
-->
	...
	<body>
		<div class="container" style="border:1px solid #f1f1f1;">
			<div class="header" style="padding:10px; background:#F1F1F1;  " align="center">
				<a href="#"><img src="http://janbaskdemo.com/jbworkdesign/img/jbt-logo-color.png" alt="JanBask Training" name="Janbask Training"  id="Janbask Training" style="" /></a> 
			</div>
			<div class="content" align="center" style=" margin-bottom:10px; ">
				<h1 style="font-size:18px;">Welcome and Thank you for registering at JanBask Training!</h1>
				<div align="center"><a style="cursor:default;" href=""><img src="<?php	echo site_url("assets/email_images/1442878814251.png");	?>" style="width:70%;"></a></div>
				<div style=" background:#fff; background-position:top; padding:10px;">
					<p align="center">Congratulations! Your account has been created which requires to be verified before Login by clicking on the below Verify button.
<br><br>
						<a href="<?php	echo $url;	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff; text-decoration:none;">Verify Email Now</a><br><br>
Also you can copy and paste the Following URL in browser to verify your account - <?php	echo $url;	?>
					</p>
					<p align="center">
