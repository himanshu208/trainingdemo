...
<div class="container" style="border:1px solid #f1f1f1;">
  ...
  <h1 style="font-size:18px;">Password Reset Sucessfully</h1>
  <p align="center">Now you can Login in to your account and start Online learning, <br><br>

    <a href="http://janbaskdemo.com/jbworkdesign/login.php" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff; text-decoration:none;">Login Now</a><br><br>
    </p>
