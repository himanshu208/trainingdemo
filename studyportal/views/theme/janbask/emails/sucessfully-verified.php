...
<div class="container" style="border:1px solid #f1f1f1;">
  ...
  <h1 style="font-size:18px;">Congratulations!!<br>

                                 Account Verified Successfully
</h1>
  <p align="center">Now you can Login into your account and Experience Online Learning.<br><br>

    <a href="<?php	echo site_url('login');	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff; text-decoration:none;">Login Now</a><br><br>
    </p>
