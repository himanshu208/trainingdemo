...
<div class="container" style="border:1px solid #f1f1f1;">
  ...
  <h1 style="font-size:18px; padding-left:20px;" align="left">Hi <?php	echo $name;	?>,</h1> 



 </h1>
  <p align="justify" style="padding:0 20px;">
The Class joining detail is given below, Please follow the instruction to join the Class.<br>
...
<h2 style="margin:5px 0px;">Class Details</h2>
    <table width="100%" style=" font-size:14px; padding:10px;border-collapse: collapse;
    border-spacing: 0;">
  <tr align="center" class="tablehead">
  
    <th  align="left">Course Name</th>
     <th scope="col" align="left">Class Name</th>
    <th scope="col" align="center">Class Timings</th>
    <th scope="col" align="right">Class By</th>
    
  </tr>
  <tr align="center" class="tablecontent">
    <td align="left" style=""><?php	echo $class_details[0]->course_name;	?></td>
    <td align="left" style=""><?php	echo $class_details[0]->title;	?></td>
    <td style=""><strong><?php	echo date("h.i",strtotime($class_details[0]->class_time));	?> <?php	echo $class_details[0]->am_pm;	?> <?php	echo $class_details[0]->time_zone;	?></strong><br>
	<?php	echo date("d M Y",strtotime($class_details[0]->class_date));	?>
</td>
    <td align="right" style=""><?php	echo $class_details[0]->trainer_name;	?></td>
    
  </tr>
  <tr align="center" class="tablecontent" >
    <td style=" padding:10px;" colspan="4" >Class Joining Link - <a href="<?php	echo $class_details[0]->live_class_url;	?>" style="padding:5px 10px; border-radius:5px; background:#000; color:#fff !important; text-decoration:none;">Join Now</a></td>
...
<p>   <strong>Instructions to Join Class:</strong><br>

1. You doesn’t need to Sign up or Create Account on WebEx; you can join daily classes as 'Guest'<br>

2. After you click on the link - Enter your name and e-mail<br>

3. Click - Join as Guest - Button<br>

4. You might be asked to Install WebEx Application or Temporary Install Application or Add to the Browser. Please do anyone of that.<br>

5. Upon Meeting Application installation completion, you will be directed in the Online Class.<br>

6. You need to connect to 'Audio' to listen the class audio. Please find Audio option on that screen - and you can use 'Call Using Computer' option in order to connect to the Audio.<br>

7. You can also use the 'I will Call In' option and dial that phone number given to connect to Audio.<br>

8. Please use your headphones to avoid class noise.
</p>
<p align="center">In case of any issue regarding the Joining the Class<br>
Write Us at <strong>support@janbasktraining.com</strong><br>
Or Call Us at <strong>+1-1111111111</strong>
