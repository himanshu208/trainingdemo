              ...
              <tbody>
                ...
                <tr class="users">
                  ...
                  <td><?php echo $list->state_name;?></td>
				   ...
				   <td> <a href="javascript:;" class="delete_record" table_id="<?php echo $list->id;?>" table_name="common_enuiry" table_id_name="id"><i class="icon-remove"></i></a> &nbsp;  <a href="javascript:;" ><i class="icon-pencil"></i></a></td>
