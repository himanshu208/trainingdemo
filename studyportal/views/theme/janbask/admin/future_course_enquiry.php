...
<div id="content" style="background-color:#fff;">
  <div id="content-header" >
    <div id="breadcrumb"> <a href="<?php	echo site_url('myadmin');	?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Future Course Enquiries</a> </div>
    <h1>Future Course Enquiries</h1>
  </div>
              ...
              <tbody>
                ...
                <tr class="users">
                  ...
                  <td><?php echo $list->email;?></td>
                   ...
                   <td><?php echo $list->suitable_timing;?></td>
				   ...
				   <td> <a href="javascript:;" class="delete_record" table_id="<?php echo $list->id;?>" table_name="future_training_enquiries" table_id_name="id"><i class="icon-remove"></i></a></td>
