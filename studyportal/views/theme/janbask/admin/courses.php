		...
		<div id="content" style="background-color:#fff;">
			<div id="content-header" >
				<div id="breadcrumb">
					...
					<a href="#" class="current">Manage Courses</a>
				</div>
				<h1>Courses Running List</h1>
			</div>
			<div class="container-fluid">
				<a href="<?php	echo site_url('myadmin/add-new-course');	?>" class="btn btn-success">Add New Course</a>
				<hr>
				<h3>Courses</h3>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php if(isset($course_arr) && !empty($course_arr))
						{
				...
				?>
								<tr class="users">
								  ...
								  <td>JB<?php echo $course->course_id;?></td>
								  <td><?php echo $course->name;?></td>
								 <td>
								  <a href="<?php echo site_url("myadmin/edit-course/".$course->course_id);?>"><i class="icon-pencil"></i></a>
								  <a href="javascript:;" class="delete_record" table_id="<?php echo $course->course_id;?>" table_name="courses" table_id_name="course_id"><i class="icon-remove"></i></a></td>								  
								</tr>
				<?php 		}	 
						}
						else
