		...
		<div id="content" style="background-color:#fff;">
			<div id="content-header" >
				<div id="breadcrumb">
					...
					<a href="#" class="current">Add New Batch</a>
				</div>
			</div>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<?php	echo form_open_multipart("",array("id"=>"add_new_batch_form","class"=>"form-horizontal"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php
												...
												echo form_dropdown("batch_course_selected",$course_list,'',array("id"=>"batch_course_selected"));
											?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Date Format 2017-04-25 Y-m-d","id"=>"batch_start_date","name"=>"batch_start_date"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Date Format 2017-04-25 Y-m-d","id"=>"batch_end_date","name"=>"batch_end_date"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Time Format 16:00:00 H:m:s","id"=>"batch_start_time","name"=>"batch_start_time"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Time Format 18:00:00 H:m:s","id"=>"batch_end_time","name"=>"batch_end_time"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Time Zone","id"=>"batch_time_zone","name"=>"batch_time_zone"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php
												...
												echo form_dropdown("batch_am_pm",$am_pm,'',array("id"=>"batch_am_pm"));
											?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Enter Currency","id"=>"batch_currency","name"=>"batch_currency"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Duration Period as 1/2/3/4","id"=>"batch_duration_period","name"=>"batch_duration_period"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Enter Duartion as days/weeks/months","id"=>"batch_duration_in","name"=>"batch_duration_in"));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php
												...
												echo form_dropdown("batch_type",$batch_type,'',array("id"=>"batch_type"));
											?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php
												...
												echo form_dropdown("batch_front_status",$front_status,'',array("id"=>"batch_front_status"));
											?>
