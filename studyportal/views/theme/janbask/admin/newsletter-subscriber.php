...
<div id="content" style="background-color:#fff;">
  <div id="content-header" >
    <div id="breadcrumb"> <a href="<?php	echo site_url('myadmin');	?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Newsletter Subscriber List</a> </div>
    <h1>Newsletter Subscriber List</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
				<?php if(isset($subscriber_arr) && !empty($subscriber_arr))
						{
				...
				?>
								<tr class="users">
								  ...
								  <td>JB<?php echo $subscriber->id;?></td>
								  <td><?php echo $subscriber->email;?></td>
								  <td><?php echo date("M,d,Y", strtotime($subscriber->register_date));?></td>
								  <td>
								  <a href=""><i class="icon-pencil"></i></a>
								  <a href="javascript:;" class="delete_record" table_id="<?php echo $subscriber->id;?>" table_name="newsletter_emai" table_id_name="id"><i class="icon-remove"></i></a></td>								  
