...
<div id="content" style="background-color:#fff;">
  <div id="content-header" >
    <div id="breadcrumb"> <a href="<?php	echo site_url('myadmin');	?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Non Couse Start Enquiries</a> </div>
    <h1>Non Couse Start Enquiries</h1>
  </div>
              ...
              <tbody>
                ...
                <tr class="users">
                  ...
                  <td><?php echo $list->email;?></td>
                   <td><?php echo $list->course_interested;?></td>
                   <td><?php echo $list->location;?></td>
                   <td><?php echo $list->register_date;?></td>
                  <td> <a href="javascript:;" class="delete_record" table_id="<?php echo $list->id;?>" table_name="non_started_ourse_enquiries" table_id_name="id"><i class="icon-remove"></i></a></td>
                </tr>
			  <?php }?>
