		...
		<div id="content" style="background-color:#fff;">
			<div id="content-header" >
				<div id="breadcrumb">
					...
					<a href="#" class="current">Manage Batches</a>
				</div>
				<h1>Batches Running List</h1>
			</div>
			<div class="container-fluid">
				<a href="<?php	echo site_url('myadmin/add-new-batch');	?>" class="btn btn-success">Add New Batch</a>
				<hr>
				<h3>Batches</h3>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php if(isset($batch_arr) && !empty($batch_arr))
						{
				...
				?>
								<tr class="users">
								  ...
								  <td><?php echo date("h.i", strtotime($batch->end_time));?></td>
								  <td><?php echo $batch->currency." ".$batch->amount;?></td>
								  <td>
								  <a href="<?php echo site_url('myadmin/edit_batch/'.$batch->id);?>"><i class="icon-pencil"></i></a>
								  <a href="javascript:;" class="delete_record" table_id="<?php echo $batch->id;?>" table_name="batches" table_id_name="id"><i class="icon-remove"></i></a></td>								  
								</tr>
				<?php 		}	 
						}
						else
