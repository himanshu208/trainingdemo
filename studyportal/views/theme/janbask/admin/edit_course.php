		...
		<div id="content" style="background-color:#fff;">
			<div id="content-header" >
				<div id="breadcrumb">
					...
					<a href="<?php	echo site_url('myadmin/courses');	?>" title="Go to Course List" class="tip-bottom"> Courses</a>
					<a href="#" class="current">Edit Course</a>
				</div>
			</div>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								...
								<?php	echo form_open_multipart("",array("id"=>"edit_course_form","class"=>"form-horizontal"));	?>
								<input type="hidden" id="course_id" name="course_id" value="<?php echo $single_data[0]->course_id;?>">
									<div class="control-group">
										<label class="control-label">Name :</label>
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Name","id"=>"course_name","name"=>"course_name",'value'=>$single_data[0]->name));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Enter Amount","id"=>"course_amount","name"=>"course_amount",'value'=>$single_data[0]->amount));	?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php	echo form_input(array("type"=>"text","class"=>"span11","placeholder"=>"Enter Cuurency","id"=>"course_currency","name"=>"course_currency",'value'=>$single_data[0]->currency));	?>
									...
									<div class="control-group">
										...
										<div class="controls"><img src="<?php	echo site_url('assets/sitefiles/images/course/'.$single_data[0]->image);	?>" width="50px">
										</div>
									</div>
