...
class Stripe_payment  {
	...
	function makePayment($stripeKey,$stripeToken,$amount,$description){   // Stripe Secret Key, Stripe Token, Amount
 			try{
			 ...
			 return    $arr=array('success'=>1,'error'=>0);
					...
					$arr=array('error'=>1,'success'=>0,'msg'=>"Card errors are the most common type of error you should expect to handle. They result when the user enters a card that can't be charged for some reason.".$e->getHttpStatus());	
							return $arr;
