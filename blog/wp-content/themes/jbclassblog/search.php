  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12  wow fadeInLeft  " align="left" style="">
        ...
        <br>
        <div class=" col-md-3 col-sm-12 col-lg-3 col-xs-12"><h2 class="inside-banner" style="color:#2980B9 !important;" align="left"><?php printf( __( 'Search Results for: %s', 'twentythirteen' ), get_search_query() ); ?></h2></div>
        ...
        <div class="input-group">
                ...
                <input type="text" class="form-control" name="s" placeholder="Search JanBask Blogs..." style="border:solid 1px #418FDE;" value="<?php echo get_search_query() ?>">
...
<section id="about" class="padding-top-bottom " style="  background-position: 100% 0%; background-repeat:no-repeat;">
  <div class="container">
	...
	<?php while(have_posts()): the_post(); ?>
	  ...
	  <?php endwhile;?>
		<?php else : ?>
		 <div class="col-md-12 col-sm-12 col-xs-12 blog-listing wow fadeInUp" data-wow-duration="300ms">
		 <h2>No Post Found For : <?php printf( __( ' %s', 'twentythirteen' ), get_search_query() ); ?></h2>
		 </div>
